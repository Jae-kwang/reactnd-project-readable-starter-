...
class NewPost extends Component {
  ...
  render() {
    ...
    return (
      <Modal
        trigger={<Button onClick={this.handleOpen}>New Post</Button>}
          ...
          <Modal.Description>
            <Form action="/posts" onSubmit={(e) => this.handleSumbit(e)}>
              <Form.Group widths='equal'>
                <Form.Field control={Input} label='Title' name="title" placeholder='Title' onChange={this.handleChange}/>
                <Form.Field control={Input} label='Author' name="author" placeholder='Author' onChange={this.handleChange}/>
                <Form.Field control={Select} label='Category' name="category" options={options} placeholder='Category' onChange={this.handleSelectChange}/>
              </Form.Group>
